...
<style>
 ...
 <div>
  ...
  <form action="./item category/av_search.php" target="iframe_5" method="post"> 
    ...
    <input type="submit"  value="Search" style="position:absolute; top:0px; left:125px;" />  
    </form>
</div>
    ...
    $result = mysqli_query($connection,"SELECT * FROM menu_db where item_category ='".$_GET["cat"]."'");
