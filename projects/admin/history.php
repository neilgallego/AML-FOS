        ...
        <div id="page-wrapper" >
            <div id="page-inner">
              <div class="panel-body">
               ...
               <div class="row">
                    <div class="col-md-8">
                         <form role="form" name="submit" action="history.php" method="post">
                    ...
                    <!-- Advanced Tables -->
                      ...
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            if (isset($_POST['from'])){
                                ...
                                $to = $_POST['to'];
                                ?>                                <?php
                                $sql="SELECT *  FROM charge_history WHERE chargeddate_history BETWEEN '$from' AND '$to' order by chargedwaiter_history";
                                ...
                                $result = mysqli_query($connection,$sql);
                                  ...
                                  while($row = mysqli_fetch_array($result)) {
                                    ?>                                    
                                  <tr>
                                     <td> <?php echo $row['chargeddate_history']; ?></td>
                                      <td> <?php echo $row['chargedwaiter_history']; ?></td>
                                     <td> <?php echo $row['chargedtime_history']; ?></td>
                                     <td> <?php echo $row['chargedname_history']; ?></td>
                                     <td> <?php echo $row['chargedtype_history']; ?></td>  
                                    <td> <?php echo $row['chargedquantity_history']; ?></td>   
                                     <td> <?php echo $row['chargedprice_history']; ?></td>            
                                        </tr>
