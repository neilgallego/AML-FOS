    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html"><img src="logo.png" alt="merkery_logo" class="hidden-xs hidden-sm">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="manage.php"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manage Menu</span></a></li>
                        <li><a href="logout.php" onclick="return confirm('Do you really want to Log Out?');"><i class="fa fa-power-off" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Log Out</span></a></li>
                    </ul>
                </div>
            </div>
        ...
        <h3> Regular hour</h3>
            ...
            <tbody>
                ...
                if(isset($_REQUEST["search_submit"])){
                    $index = 0;
                    $time = $_REQUEST[""];
                    $stmt = $dbase->getMenureg($name);
                    mysqli_stmt_bind_result($stmt,$name,$item_category,$item_happyprice);
                ...
                <?php   
                        ...
                        $stmt = $dbase->getMenureg($start, $end);
                        mysqli_stmt_bind_result($stmt,$name,$item_category,$item_happyprice);
                        while(mysqli_stmt_fetch($stmt)){
                    ?>
                    <tr>
