    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html"><img src="logo.png" alt="AML_logo" class="hidden-xs hidden-sm">
                       
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li><a href="transac.php"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
                        <li><a href="register.php"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Register</span></a></li>
                        <li><a href="Summaries.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Summaries</span></a></li>
                        <li><a href="users.php"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Users</span></a></li>
                        <li class="active"><a href="manage.php"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hidden-xs hidden-sm"> Menu</span></a></li>
                        <li><a href="tables.php"><i class="fa fa-table" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Tables</span></a></li> -->
                          <li><a href="comm.php"><i class="fa fa-money" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Commission</span></a></li>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="manage.php">Happy Hour</a></li>
      <li class="active"><a href="reghour.php">Regular Hour</a></li>
    </ul>
  </div>
  </nav>

                        <div id="register-form">
                                <h2 class="form-signin-heading">Search Menu <i class="fa fa-search" aria-hidden="true"></i></h2>
                                <form action="menuavail.php" method="get">
                                <p>Name: 
                                <input type="text" name="search-id" placeholder="Crispy Pata" maxlength="50" 
                                                required><input type="submit" name="search_submits" value="Search"></p>
                                </form>
                                ...
                                <?php
                                   /*  include "dbase.php";
                                    ...
                                    $activate = $dbase->deactivate($nameSearched);
                                   ...
                                   if(isset($_REQUEST["savers"])){
                                    ...
                                    echo '<script>alert("Succesfully updated member status to active");</script>';
                                        ...
                                        if(isset($_REQUEST["search_submits"])){
                                            ...
                                            $stmt = $dbase->getavail($name);
                                            mysqli_stmt_bind_result($stmt, $name, $item_category, $item_availability);
        ...
        <table id="examplesa" class="display" cellspacing="0" width="70%">
                        <tr>
                            <td>Name:</td>
                        ...
                        <tr>
                            <td>Availability</td>
                            <td><input type="text" name="item_availability"  value="<?php echo $item_availability; ?>"></td>
                        </tr>
                    ...
                    <?php 
                            ...
                            ?>
                             <tr>
                            <button class="btn btn-lg btn-primary btn-block" type="savers" name="savers" style="width: 320px">Activate</button>
                            <button class="btn btn-lg btn-primary btn-block" type="saverss" name="saverss" style="width: 320px">Deactivate</button>
                        </tr>
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    ...
                                    <b><?php date_default_timezone_set("Asia/Manila"); 
                            echo $today = date("F j, Y g:i A");?></b>
                                   <a href ="logout.php" onclick="return confirm('Do you really want to Log Out?');"> <button type="button" class="btn btn-primary">
...
<table id="example" class="display" cellspacing="0" width="100%">
        ...
        <h3> Menu Availability</h3>
            ...
            <tbody>
                ...
                if(isset($_REQUEST["search_submit"])){
                    $index = 0;
                    $time = $_REQUEST[""];
                    $stmt = $dbase->getAvailability($name);
                    mysqli_stmt_bind_result($stmt,$name,$item_category,$item_availability);
                    while(mysqli_stmt_fetch($stmt)){
                        $index++
                        ?>
                        <tr>
                            ...
                            <td><?php echo $item_availability; ?></td>
                ...
                <?php   
                        ...
                        $stmt = $dbase->getAvailability($start, $end);
                        mysqli_stmt_bind_result($stmt,$name,$item_category,$item_availability);
                        while(mysqli_stmt_fetch($stmt)){
                    ?>
                    <tr>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="save" name="back" style="width:70px; height:45px" onClick="history.go(-1);">Back</button>
